...
@section('content')
    ...
    <h1 class="text-center col-8">Crear Cliente</h1>
    <br>
    <form action="{{ route('clientes.store') }}" method="POST">
        ...
        <div class="fluid-container text-center">
            ...
            <div class="row align-self-start">
                ...
                <input type="text" id="apellidos" name="apellidos" value="{{ old('apellidos') }}" class="col-6">
                @error('apellidos')
                    <small style="color: crimson"> {{ $message }} </small>
                    <br/>
                @enderror
            ...
            <div class="row align-self-start">
                ...
                <input type="email" id="email" name="email" value="{{ old('email') }}" class="col-6">
                @error('email')
                    <small style="color: crimson"> {{ $message }} </small>
                    <br/>
                @enderror
            ...
            <div class="row align-self-start">
                ...
                <input type="text" id="telefono" name="telefono" value="{{ old('telefono') }}" class="col-6">
                @error('telefono')
                    <small style="color: crimson"> {{ $message }} </small>
                    <br/>
                @enderror
